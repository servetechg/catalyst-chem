...
export const HERO = {
  eyebrow: 'Sourcing Chemistry.',
  eyebrowHighlight: 'Delivering Trust.',
  title:
    'Reliable Chemical Raw Materials, Powered by Global Sourcing, Strategic Terminals & Flexible Supply Solutions',
  description:
